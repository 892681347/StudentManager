...
<html>
	...
	<body>
		<div class="alert alert-success" style="text-align: center;font-size: 20px;">新增老师</div>
		<div class="middle" id="middle">
			<form action="${pageContext.servletContext.contextPath}/addTeacher.do" method="post">
				...
				<div class="input-control has-label-left margind">
				  <div>班级：</div><input type="text" class="form-control paddingleft" name="tclass"/>
				</div>
